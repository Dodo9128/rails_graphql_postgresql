...
rolling = Author.create(first_name: 'J.K', last_name: 'Rolling', date_of_birth: Date.parse('1976-10-11'))
...
Book.create(title: 'Harry Potter and Chamber of Secret', author: rolling, publication_date: 1999, genre: 'Harry_Potter')
Book.create(title: 'Harry Potter and Wizard`s stone', author: rolling, publication_date: 1996, genre: 'Harry_Potter')
Book.create(title: 'Harry Potter is God-God', author: rolling, publication_date: 2001, genre: 'Harry_Potter')